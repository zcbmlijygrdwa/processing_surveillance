...
void setup() {
  ...
  file = new SoundFile(this, "bing.wav");
}
...
void draw() {
  if (video.available()) {
    ...
    triggerThres = 0.9999f*triggerThres + 0.0001f*movementSum;
    ...
    {
      triggerThres = stadbyRatio*movementSum;
      if(frameCount>=initializationTime){
       isInit = true; 
      }
    }
  }
...
void saveCurrentFrame() { 
   image(video, 0, 0); 
   saveFrame("data/imageCounter_"+imageCounter+".jpg"); 
   imageCounter++;
} 
